...
test.describe("LicenseGuard Basic Flow", () => {
  ...
  test("should complete full workflow: login, upload, process, and display results", async ({ page }) => {
    ...
    // 3. mock the streaming analysis API endpoint
    ...
    // 4. fill in project details and upload file
    ...
    // 5. wait for the analysis result to appear
    ...
    // 6. verify the complete analysis report is displayed with expected format
